    ...
    return function featureParser(filepath)
    {
        ...
        content.forEach((line) => {
            ...
            switch (type) {
                ...
                case 'tag':
                    feature.tags.push(grabValue(line, type));
                    break;
                ...
                case 'background':
                    if (focus !== 'feature') throw new Error('unexpecte token: "background"');
                    focus = type;
                ...
                case 'examples':
                    ...
                    else throw new Error('unexpecte token: "examples"');
                    break;
                ...
                case 'table row':
                    ...
                    else throw new Error('unexpecte token: "table row"');
                    break;
